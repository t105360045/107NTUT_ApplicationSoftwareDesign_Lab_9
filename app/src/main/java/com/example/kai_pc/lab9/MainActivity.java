package com.example.kai_pc.lab9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startService(i);
                Toast.makeText(MainActivity.this,"Servise啟動成功",Toast.LENGTH_SHORT).show();
        ...
        myBroadcasReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                int myInt = myBundle.getInt("background_servise");

                run_time.setText("後台Servise執行了"+myInt+"秒");
            }
        };
